...
function jarvis_get_fonts() {
	...
	$fonts = array(
		...
		'copperplate' => [ 'Copperplate', 'Copperplate, Copperplate Light, Copperplate Gothic Light, serif' ],
		'copperplate-light' => [ 'Copperplate Light', 'Copperplate Light, Copperplate Gothic Light, serif' ],
		...
		'cormarant-infant' => [ 'Cormarant Infant', 'Cormorant Infant, Georgia, serif' ],
		...
		'interui' => [ 'InterUI', 'InterUI, Arial, sans-serif' ],
